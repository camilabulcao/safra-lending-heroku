...
export class ThirdScreenComponent implements OnInit {
  @Output() nextStepFour = new EventEmitter();
  @Output() returnStepTwo = new EventEmitter();
  ...
  nextStepThird() {
    this.nextStepFour.emit(this.stepFour)
  }
  ...
  public setFineshStep() {
    ...
    this.nextStepFour.emit(this.fineshStep)
  }
  ...
  public retornPage2() {
    this.stepSecondary = true;
    this.returnStepTwo.emit(this.stepSecondary)
  }
